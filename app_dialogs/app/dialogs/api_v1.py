...
from app.dialogs.resource import dialog_list, dialog_detail
...
def index(dialogs_repo: DialogsRepo):
    ...
    return dialog_list(profile_id, dialogs_repo.find_dialogs(profile_id))
...
def detail(dialog_id: int, dialogs_repo: DialogsRepo, messages_repo: DialogMessagesRepo):
    ...
    return dialog_detail(profile_id, dialog, messages)
